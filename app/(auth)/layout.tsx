  ...
  return (
    <div className='flex min-h-screen'>
        <section className='hidden w-1/2 items-center justify-center bg-brand p-10 lg:flex xl:w-2/5'>
            ...
            <Image src="/logo.png" alt='logo' width={224} height={84} className='h-auto' ></Image>
            <div className='space-y-5 text-white'>
            <h1 className='h1' >
                Manage your files as you want.
            </h1>
            <p className='body-1'>
                This is the best place to store your documents and share accross ppl.
            </p>
        </div>
