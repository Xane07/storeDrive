...
const Card = ({ file }: { file: Models.Document }) => {
  return (
    <Link href={file.url} target="_blank" className="file-card min-h-[140px] overflow-hidden">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 flex-1 items-center gap-4">
          ...
          />
          <p className="subtitle-1 line-clamp-2 min-w-0 flex-1 break-words">{file.name}</p>
        </div>
